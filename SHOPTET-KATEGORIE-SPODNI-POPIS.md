# Shoptet - Spodní popis kategorií (Kompletní přehled)

## 📋 Úvod

Tento dokument obsahuje **kompletní přehled všech spodních popisů kategorií** připravených pro integraci do e-shopu HelloComp.cz na platformě Shoptet. Každý spodní popis obsahuje sekci "Související kategorie" pro interní propojení a SEO optimalizaci.

**Datum vytvoření:** 19. února 2026  
**Verze:** 1.0  
**Platforma:** Shoptet  
**Jazyk:** Čeština
...
## 🎯 Rychlý přehled - Souhrn všech kategorií

| #  | Kategorie | Soubor | Stav |
|----|-----------|--------|------|
...
## 📝 Detailní popis jednotlivých kategorií

### 1. Herní PC do 15 000 Kč

**URL kategorie:** https://www.hellocomp.cz/herni-pocitace-do-15000/  
**Soubor:** `herni-pocitac-do-15000-spodni-sekce.md`  
**Typ:** Cenová kategorie - vstupní úroveň
...
**Poznámky:**
- Neobsahuje self-link (odkaz na sebe)
- Odkazuje na vyšší cenové hladiny (20k, 25k)
...
**URL kategorie:** https://www.hellocomp.cz/herni-pocitace-do-20000/  
...
**Typ:** Cenová kategorie - vyšší střední úroveň
...
**Typ:** Cenová kategorie - vyšší úroveň
...
**Poznámky:**
- Odkazuje na sousední cenové hladiny (30k, 60k)
- Obsahuje 13 interních odkazů
...
**Typ:** Cenová kategorie - prémiová úroveň
...
**Poznámky:**
- Nejvyšší cenová kategorie - odkazuje pouze na nižší (40k)
...
**URL kategorie:** https://www.hellocomp.cz/herni-pocitace--gaming/  
**Soubor:** `herni-pocitace-obecna-spodni-sekce.md`  
**Typ:** Hlavní kategorie - rozcestník
...
**Poznámky:**
- Hlavní rozcestník - obsahuje odkazy na VŠECHNY cenové kategorie
- Obsahuje 16 interních odkazů
- Nejdůležitější kategorie pro SEO

---

### 8. Repasované herní PC

**URL kategorie:** https://www.hellocomp.cz/repasovane-herni-pc/  
**Soubor:** `repasovane-herni-pc-spodni-sekce.md`  
...
**Poznámky:**
- Cross-sell na kancelářské PC a pracovní stanice
- Obsahuje 16 interních odkazů
...
**Poznámky:**
- Cross-sell na komponenty profesionálního hardwaru
- Obsahuje 14 interních odkazů
...
## 🔧 Jak integrovat do Shoptetu

### Krok za krokem návod:

1. **Přihlaste se do administrace Shoptetu**
   - Přejděte do sekce E-shop → Kategorie

2. **Vyberte kategorii**
   - Najděte příslušnou kategorii podle URL (viz tabulka výše)

3. **Upravte popis kategorie**
   - Přejděte do editace kategorie
   - Otevřete pole "Popis kategorie" nebo "Spodní popis"

4. **Vložte obsah**
   - Zkopírujte obsah z příslušného souboru
   - Vložte na konec stávajícího popisu kategorie
   - Před vložením přidejte oddělovač (volitelné): `---`

5. **Nastavte formátování**
   - Použijte HTML editor v Shoptetu
   - Nadpis H2: `<h2>Související kategorie</h2>`
   - Seznam odkazů: `<ul><li><a href="URL">Text odkazu</a></li></ul>`

6. **Uložte a publikujte**
   - Zkontrolujte náhled
   - Uložte změny
   - Ověřte na front-endu webu

### Příklad HTML kódu pro Shoptet:
...
<ul>
  <li><a href="https://www.hellocomp.cz/herni-pocitace--gaming/">Herní počítače</a></li>
  <li><a href="https://www.hellocomp.cz/jak-si-vybrat-herni-pc/">Jak vybrat herní PC</a></li>
  <li><a href="https://www.hellocomp.cz/herni-pocitace-do-20000/">Herní PC do 20 000 Kč</a></li>
  <!-- další odkazy -->
</ul>
```
...
- [ ] Sekce "Související kategorie" je na konci popisu kategorie
- [ ] Je přidán oddělovač (---) nebo `<hr>` před sekcí
- [ ] Všechny odkazy jsou funkční (zkontrolujte náhodný vzorek)
- [ ] Kategorie NEODKAZUJE sama na sebe (žádný self-link)
- [ ] Formátování odpovídá zbytku stránky
- [ ] Text je v češtině a odpovídá stylu HelloComp
- [ ] HTML kód je validní (pokud používáte HTML editor)
- [ ] Sekce je viditelná na front-endu webu

---

## 📊 SEO benefity implementace

### Interní linkování
- Distribuuje "link juice" napříč kategoriemi
- Zvyšuje autoritu jednotlivých stránek
- Pomáhá indexaci všech kategorií

### Uživatelská navigace
- Zákazníci snadno najdou související produkty
- Snižuje bounce rate
- Zvyšuje page views per session

### Obchodní výhody
- Upsell/cross-sell příležitosti
- Zvyšuje průměrnou hodnotu objednávky
- Pomáhá zákazníkům objevit správnou cenovou hladinu
...
### Kdy aktualizovat:
- **Nové kategorie**: Vytvoření nové kategorie → aktualizujte související kategorie
- **Změna URL**: Změna URL kategorie → aktualizujte všechny odkazy
- **Nové cenové hladiny**: Přidání nové cenové hladiny → aktualizujte sousední kategorie
- **Měsíční kontrola**: Ověřte funkčnost všech odkazů

### Jak udržovat konzistenci:
- Používejte tento dokument jako referenci
- Dodržujte formát "Související kategorie"
- Neodkazujte kategorii samu na sebe
- U cenových kategorií vždy odkazujte na sousední hladiny

---

## 📞 Kontakt a podpora

V případě dotazů nebo problémů při implementaci kontaktujte:
- **Repozitář:** tomasberka/content-automation-tool
- **Dokumentace:** Tento soubor + NAVOD-K-POUZITI.md

---

## 📝 Poznámky k verzím

**Verze 1.0** (19. února 2026)
- Počáteční vytvoření dokumentu
- 12 kategorií dokumentováno
- Návod na integraci do Shoptetu
- HTML příklady a kontrolní seznam

---

## 📦 Umístění souborů v repozitáři

Všechny soubory se nachází v kořenovém adresáři:
